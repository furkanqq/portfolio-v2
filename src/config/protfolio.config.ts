...
const portfolio: PortfolioType[] = [
  ...
  },
  {
    ...
    img: "https://res.cloudinary.com/ddfqedsqq/image/upload/v1781872371/galerieqr-cover_icszl0.webp",
    link: "https://www.galerieqr.com/",
  ...
  },
  {
    title: "f-solve",
    params:
      "Responsive Design, NextJS, Tailwind CSS, TypeScript, i18n, Framer Motion",
    desc: "F-Solve delivers premium web experiences from concept to launch, combining elegant design, performance, and user-focused solutions to help brands stand out online.",
    img: "https://res.cloudinary.com/ddfqedsqq/image/upload/v1781907073/f-solve-cover_wruxx9.webp",
    link: "https://f-solve.com/",
    // githubLink: "https://github.com/furkanqq/f-ball",
    githubLink: "",
    visit: true,
    githubVisit: false,
  },
  {
    title: "f-ball",
    params:
      "Responsive Design, NextJS, Tailwind CSS, TypeScript, Supabase, i18n, Socket.IO, zustand,",
    desc: "F-Ball is a real-time football party game where friends can play quick football challenges in the same room.",
    img: "https://res.cloudinary.com/ddfqedsqq/image/upload/v1781873547/f-ball-cover_abzhfo.webp",
    link: "https://f-ball.vercel.app/",
    // githubLink: "https://github.com/furkanqq/f-ball",
    githubLink: "",
    visit: true,
    githubVisit: false,
  ...
  },
  {
    title: "Aurum",
    params:
      "GSAP, Framer motion, Tailwind Css, NextJS, TypeScript, Responsive Design, Nodemailer",
    desc: "Aurum is a custom watch platform where users can configure their ideal timepiece and request a personalized quote.",
    img: "https://res.cloudinary.com/ddfqedsqq/image/upload/v1781875006/aurum-cover_zpma7o.webp",
    link: "https://aurum-beige-beta.vercel.app/",
    githubLink: "",
    githubVisit: false,
    visit: true,
  },
